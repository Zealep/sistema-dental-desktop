...
public class FrmRespaldarDB extends javax.swing.JInternalFrame {
    ...
    private void btnBackupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackupActionPerformed
        ...
        if (txtRuta.getText().equals("")) {
            ...
            String command = "mysqldump -u " + user + " -p"+pass+" --add-drop-database -B " + dbnombre + " -r " + "\"" + txtRuta.getText().toString() + "\\" + strFilename + ".sql\"";
            //String command = "-u " + user + " -p"+pass+" --add-drop-database -B " + dbnombre + " -r " + "\"" + txtRuta.getText().toString() + "\\" + strFilename + ".sql\"";

            System.out.println(command);
            Process p = null;
            try {
                Runtime runtime = Runtime.getRuntime();
                //p = runtime.exec(new String[] { "cmd","\\c",command});
                p = runtime.exec("C:\\Program Files\\MySQL\\MySQL Server 5.7\\bin\\mysqldump.exe "+command);
