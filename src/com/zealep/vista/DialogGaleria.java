...
import com.zealep.util.GaleriaExamenes;
 ...
 * @author user
 */
public class DialogGaleria extends javax.swing.JDialog {

    ImagenDAO imagenDAO = new ImagenDAO();
    public static int idExamen;
   List<String> rutas = new ArrayList<>();
    GaleriaExamenes Mi_Galeria = new GaleriaExamenes(idExamen);
    private int a = 0;
    private int b = 1;
    private int c = 2;
    private int d = 3;
    public DialogGaleria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
       this.setTitle("Galeria de Examenes del Paciente");
    ...
    private void initComponents() {
        ...
        FOTO_GRANDE.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                FOTO_GRANDEMouseClicked(evt);
            }
        });
    ...
    private void FOTO_AMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FOTO_AMouseClicked
        FOTO_GRANDE.setIcon(Mi_Galeria.getFoto(a,FOTO_GRANDE.getSize(),FOTO_GRANDE.getWidth(),FOTO_GRANDE.getHeight()));
    ...
    private void FOTO_BMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FOTO_BMouseClicked
        FOTO_GRANDE.setIcon(Mi_Galeria.getFoto(b,FOTO_GRANDE.getSize(),FOTO_GRANDE.getWidth(),FOTO_GRANDE.getHeight()));
    ...
    private void FOTO_CMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FOTO_CMouseClicked
        FOTO_GRANDE.setIcon(Mi_Galeria.getFoto(c,FOTO_GRANDE.getSize(),FOTO_GRANDE.getWidth(),FOTO_GRANDE.getHeight()));
    ...
    private void FOTO_DMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FOTO_DMouseClicked
         FOTO_GRANDE.setIcon(Mi_Galeria.getFoto(d,FOTO_GRANDE.getSize(),FOTO_GRANDE.getWidth(),FOTO_GRANDE.getHeight()));
    ...
    private void FOTO_GRANDEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_FOTO_GRANDEMouseClicked
      
        
    }//GEN-LAST:event_FOTO_GRANDEMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogGaleria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogGaleria dialog = new DialogGaleria(new javax.swing.JFrame(), true);
